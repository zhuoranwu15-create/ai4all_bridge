...
_COMPAT_EXPORT_MODULES = (
    ...
    "app.products.zhaoxi.infrastructure.persistence.companion_world",
    "app.products.zhaoxi.infrastructure.persistence.companion_world_lifecycle",
    "app.products.zhaoxi.infrastructure.persistence.companion_world_mailbox",
    "app.products.zhaoxi.infrastructure.persistence.companion_world_visits",
    "app.products.zhaoxi.infrastructure.persistence.companion_world_human_chat",
    "app.products.zhaoxi.infrastructure.persistence.notifications",
