...
# slot 调度算法已抽到 reactivation_slots（阶段1.4）；next_reactivation_slot 在此 re-import
# 仅为保持 `from app.proactive.reactivation import next_reactivation_slot` 旧路径可用。
from app.proactive.reactivation_slots import (  # noqa: F401  (next_reactivation_slot re-export)
    _account_allowed_windows,
    _next_slot_after,
    _with_default_schedule,
    format_reactivation_time,
    next_reactivation_slot,
)
