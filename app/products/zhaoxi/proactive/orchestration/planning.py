...
`from app.products.zhaoxi.proactive.store.account_state import scan_due_proactive_account_checks` 仍可用（state 惰性再导出）。
"""
...
from app.products.zhaoxi.proactive.selection.ranker import ranked_kinds
from app.products.zhaoxi.proactive.selection.selector import Proposal, select_first
...
from app.products.zhaoxi.proactive.slots import _account_allowed_windows, _with_default_schedule
