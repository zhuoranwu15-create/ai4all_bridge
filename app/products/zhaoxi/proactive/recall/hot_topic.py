...
from app.products.zhaoxi.proactive.contract.common import _clean_text, _extract_json_object, _select_route, _truncate_text
from app.products.zhaoxi.proactive.delivery.touch_state import STALE, get_account_touch_state
from app.products.zhaoxi.proactive.contract.prompts import (
    HOT_TOPIC_PERSONALIZE_SYSTEM_PROMPT,
    HOT_TOPIC_RANK_SYSTEM_PROMPT,
    HOT_TOPIC_RECALL_SYSTEM_PROMPT,
)
from app.products.zhaoxi.proactive.recall._hot_list import collect_hot_list_lines
from app.products.zhaoxi.proactive.recall._shared import _format_decision_time, _no_op
from app.products.zhaoxi.proactive.selection.diversity import rank_and_diversify
from app.products.zhaoxi.proactive.store.candidates import REACTIVATION_TYPE_HOT_TOPIC, _normalize_dedupe_key
from app.products.zhaoxi.proactive.store.global_candidates import (
    active_global_pool,
