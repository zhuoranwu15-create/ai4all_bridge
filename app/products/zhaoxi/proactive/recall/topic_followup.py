...
from app.products.zhaoxi.proactive.store.candidates import REACTIVATION_TYPE_TOPIC_FOLLOWUP
from app.products.zhaoxi.proactive.contract.prompts import TOPIC_FOLLOWUP_SYSTEM_PROMPT
