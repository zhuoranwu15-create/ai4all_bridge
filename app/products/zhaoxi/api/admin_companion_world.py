...
@router.get("/admin/companion-world/mailbox/catalog")
...
@router.post("/admin/companion-world/mailbox/catalog")
...
@router.post("/admin/companion-world/mailbox/catalog/{catalog_id}/retire")
...
@router.post("/admin/companion-world/lifecycle-events/{event_id}/correct")
