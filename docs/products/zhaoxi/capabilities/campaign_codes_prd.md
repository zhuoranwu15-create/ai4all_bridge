...
> 后续需求说明：本文定义的是**运营创建的营销活码**，继续保持“不产生个人邀请关系”的业务语义。
> 用户在个人中心创建角色模板并生成“个人邀请码 + 模板活动码”组合链接的需求，见
> [用户自建角色模板与邀请链接 PRD](creator_role_template_referral_link_prd.md)。组合发生在链接和注册编排层，
> 不把运营营销活码本身改造成个人邀请码。
