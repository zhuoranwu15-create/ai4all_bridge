...
本文承接 [记忆与上下文 PRD](../../products/zhaoxi/capabilities/memory_prd.md)、[Agent Context Files 与记忆机制](agent_context_files.md) 和 [Conversation Orchestrator 主对话场景技术设计](conversation_orchestrator_design.md)，详细定义 AI4ALL Phase 1 的 Dreaming 机制。
...
明文查看来源材料、daily notes 正文、session messages 或完整 prompt/output，必须遵守 [隐私与后台访问控制](../shared/platform/privacy_admin_access_control_design.md)。
