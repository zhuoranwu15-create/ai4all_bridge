...
> - `docs/architecture/shared/data/thick_node_postgres_refactor.md`
> - `docs/architecture/shared/access/identity_model_and_wechat_binding.md`
...
> 改造清单已抽成独立 issue 供 TDAI 团队推进：`docs/architecture/agent-runtime/tdai_multitenant_issue.md`。
