...
> 上游依据：
> - [`multi_node_access_refactor.md`](multi_node_access_refactor.md) —— 已上线的「中心大脑 + 瘦接入节点」一期，本文在其基础上把节点做厚。
...
> - [`multi_node_access_retrospective.md`](multi_node_access_retrospective.md) —— 一期复盘与技术债。
>
