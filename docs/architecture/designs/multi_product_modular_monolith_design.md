...
- [`identity_model_and_wechat_binding.md`](./identity_model_and_wechat_binding.md)、[`companion_world_account_model_reconciliation.md`](../../archive/deliveries/companion_world/companion_world_account_model_reconciliation.md)：真人身份与账号收敛模型。
