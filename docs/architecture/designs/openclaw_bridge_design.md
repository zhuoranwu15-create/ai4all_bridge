...
本文是早期 Bridge 方案文档。当前身份模型以 `docs/architecture/overview.md`、`docs/architecture/system_design.md` 和 `docs/architecture/designs/identity_model_and_wechat_binding.md` 为准：
...
- 语音输入当前以 `openclaw-weixin` 上游提供的转写文本为准，详见 `docs/architecture/designs/voice_input_design.md`；本文早期 ASR 设想不作为当前 Phase 1 实施口径。
