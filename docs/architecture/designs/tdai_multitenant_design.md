...
> - `docs/architecture/designs/thick_node_postgres_refactor.md`
> - `docs/architecture/designs/identity_model_and_wechat_binding.md`
...
> 改造清单已抽成独立 issue 供 TDAI 团队推进：`docs/architecture/designs/tdai_multitenant_issue.md`。
