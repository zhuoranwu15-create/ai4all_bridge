...
本文承接 [主动消息与提醒 PRD](../../product/proactive_prd.md)，定义 Phase 1 主动消息、用户提醒、陪伴跟进和内容邀请的技术边界。后续 `app.products.zhaoxi.proactive.*`、LLM tool use、scheduler、outbound ledger 和 OpenClaw Gateway send 相关开发以本文为准。
