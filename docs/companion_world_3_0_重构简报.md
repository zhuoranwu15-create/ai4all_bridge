...
| **M5** 访客 + 真人聊天 | slot/高熵邀请码/ACL、真人分表 | M5-0/M5-1 完成，default-off |
...
5. M4 已整理到 Draft PR #47，Ready/合并仍由用户明确决定。M5 §10.9、实现级 spec 与 m0035/纯领域/DB 原语已完成；尚未接 live API，M5 分支暂堆叠于 M4，#47 合并前不得转 Ready。
