...
| **M5** 访客 + 真人聊天 | slot/高熵邀请码/ACL、真人分表 | M5-0…M5-2 完成，default-off |
...
5. M4 已整理到 Draft PR #47，Ready/合并仍由用户明确决定。M5 已完成产品门、m0035 与 invite→pending→accept/terminal API；visitor Feed/expiry/block 和真人消息待后续批次，M5 分支暂堆叠于 M4，#47 合并前不得转 Ready。
