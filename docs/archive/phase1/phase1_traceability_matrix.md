...
> **已冻结（2026-06-15 归档）：** 本文是 Phase 1 完成时的需求-代码逐条映射快照，现已归档**不再更新**。当前现状、缺口与近期队列见 [`STATUS.md`](../../STATUS.md)；详细技术平面见 [`system_design.md`](../../system_design.md)。
>
...
8. 回头更新 [Phase 1 详细技术设计](../../system_design.md)：只保留总技术平面、目标数据模型和工作包摘要，把细节下沉到专题设计。
