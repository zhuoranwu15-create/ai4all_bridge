...
> 状态：**已完成并归档（2026-07-22）**。本文件保留为实施 provenance，不再是后续待执行计划；后续接手以 [`../../../architecture/designs/companion_world_3_0_refactor_design.md`](../../../architecture/designs/companion_world_3_0_refactor_design.md) 为入口。
>
