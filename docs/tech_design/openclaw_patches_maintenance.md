...
- aliyun1 旧版 **v2026.5.28 不漏**（单机一直正常）；这是 6.5 的回归，**aliyun1 升级到 6.5 时也会需要本补丁**。完整追查见 [`multi_node_weixin_login_investigation_20260614.md`](multi_node_weixin_login_investigation_20260614.md) §10。
