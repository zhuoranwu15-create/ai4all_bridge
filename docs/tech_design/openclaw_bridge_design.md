...
本文是早期 Bridge 方案文档。当前身份模型以 `docs/architecture_overview.md`、`docs/phase1/phase1_technical_design.md` 和 `docs/tech_design/identity_model_and_wechat_binding.md` 为准：
