...
>
> 性质：实现级规范（buildable spec），冻结 M3 migration、状态机、API、幂等、锁与 rollout 边界。上位产品决策以 [`companion_world_3_0_refactor_design.md`](./companion_world_3_0_refactor_design.md) D-10/D-13/D-15 为准。
>
