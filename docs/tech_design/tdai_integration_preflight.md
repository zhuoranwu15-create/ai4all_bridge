...
> 关联文档：`docs/tech_design/tdai_multitenant_design.md`、`/Users/suchong/workspace/TencentDB-Agent-Memory/docs/tdai_gateway_integration.md`
...
TDAI_RECALL_ACCOUNT_ALLOWLIST=aid_806382741   # 逗号分隔 account_id；空=recall 对所有账号关闭
