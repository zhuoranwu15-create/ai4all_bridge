...
- `docs/ops/platform/` 下 Phase 1 发布与回滚说明。
...
6. 发布/回滚手册见 [`multi_product_phase1_release_runbook.md`](../../ops/platform/multi_product_phase1_release_runbook.md)，明确全 writer drain、逐版本检查点和 contract 后只能前向修复。
