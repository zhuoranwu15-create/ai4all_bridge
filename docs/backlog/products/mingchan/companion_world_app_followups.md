...
权威说明。当前行为分别以
[`companion_world_app_prd.md`](../../../products/mingchan/capabilities/companion_world_app_prd.md)、
[`app_api_handoff.md`](../../../products/mingchan/app_api_handoff.md) 和提交的 OpenAPI snapshot 为准。
