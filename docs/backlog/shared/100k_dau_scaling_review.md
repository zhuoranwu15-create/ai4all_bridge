...
配套阅读：[`100k_dau_scaling_discussion_draft.md`](../../archive/backlog/100k_dau_scaling_discussion_draft.md)（更早的讨论稿，已归档）、[`production_stability_prd.md`](../../architecture/shared/platform/production_stability_prd.md)。
