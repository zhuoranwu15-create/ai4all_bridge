...
| [首次聊天 Onboarding](first_chat_onboarding_prd.md) | 绑定后两步主动引导、用户称呼、AI 称呼与人设合并设置、留白养成、跳过容错 | [Conversation Orchestrator](../tech_design/conversation_orchestrator_design.md)、[Agent Context Files](../tech_design/agent_context_files.md) |
...
| [AI 自我：人格、使命、需求与关系成长](agent_self_prd.md) | AI 自我模型：人格 × 使命组合、马斯洛三层需求、关系阶段成长、自我状态注入 prompt | [使命子系统 + 自我状态编排注入层](../tech_design/agent_mission_and_orchestration_design.md) |
