...
def test_plan_account_reset_matches_legacy_default_soul(fresh_db, tmp_path):
...
def test_plan_account_reset_matches_empty_soul(fresh_db, tmp_path):
...
def test_plan_account_reset_skips_custom_soul(fresh_db, tmp_path):
    from scripts.reset_legacy_default_souls import plan_account_reset
...
def test_plan_account_reset_missing_requires_flag(fresh_db, tmp_path):
    from scripts.reset_legacy_default_souls import plan_account_reset
