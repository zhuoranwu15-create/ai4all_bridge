...
def fresh_db(test_settings):
    ...
    patches = [
        ...
        patch("app.proactive.reactivation_slots.settings", test_settings),
        patch("app.proactive.generation.account_check.settings", test_settings),
        patch("app.proactive.generation.topic_followup.settings", test_settings),
        patch("app.proactive.generation.content_invitation.settings", test_settings),
